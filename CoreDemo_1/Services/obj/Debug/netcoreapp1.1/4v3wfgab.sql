...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20170701153522_init_7', '1.1.2');

ALTER TABLE Employee MODIFY `JobPosition` int NOT NULL DEFAULT 1;

ALTER TABLE `Employee` ADD `BirthDate` datetime NOT NULL DEFAULT 0001/1/1 0:00:00;

ALTER TABLE `Contract` ADD `EndDate` datetime NOT NULL DEFAULT 0001/1/1 0:00:00;

ALTER TABLE `Contract` ADD `StartDate` datetime NOT NULL DEFAULT 0001/1/1 0:00:00;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20170701153741_init_8', '1.1.2');
